...
slug: "/browserify-desarrollando-tu-frontend-como-en-node-js"
date: 2015-03-12
tags:
    - "💻 Desarrollo"
---
[Browserify](http://browserify.org/) es una librería de Node.js, escrita por [substack](https://www.npmjs.com/~substack), uno de los mayores contribuidores al core de Node.js y con mayor número de módulos publicados en NPM.

{<1>}![browserify](./687474703a2f2f737562737461636b2e6e65742f696d616765732f62726f777365726966795f6c6f676f2e706e67.png)

Nos permite escribir código JavaScript del cliente, como si estuviésemos programando en Node.js, es decir, como por ahora no tenemos módulos de forma nativa en JavaScript (hasta que [se implante el estándar ECMAScript6](/ecmascript6/) que si los trae) hay librerías que se encargan de imitar ese comportamiento (Caso de Require.js hace un tiempo).
...
{<2>}![hola browserify](https://carlosazaustre.es/blog/content/images/2015/03/Screen-Shot-2015-03-11-at-20-45-18.png)
...
![saludar](./Screen-Shot-2015-03-11-at-23-35-04.png)

![presentar](./Screen-Shot-2015-03-11-at-23-35-09.png)
