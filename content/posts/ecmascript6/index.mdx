...
date: "2018-10-24"
banner: "./aprende-ecmascript-6-estandar-javascript.jpg"
tags:
  - 💻 Desarrollo
slug: "/ecmascript6"
---
...
Primero un poco de historia. En 1995 (hace más de 20 años!) **[Brendan Eich](http://es.wikipedia.org/wiki/Brendan_Eich)** crea un lenguaje llamado **Mocha** cuando trabajaba en **Netscape**. En Septiembre de ese año lo renombra a *LiveScript* hasta que le cambiaron el nombre a *JavaScript* debido a una estrategia de marketing, ya que Netscape fue adquirida por *Sun Microsystems*, propietaria del lenguaje **Java**, muy popular por aquel entonces. 

>**¡Advertencia!**:  aclarar lo siguiente `Java != JavaScript`.
>
>![JavaScript no es Java](./meme-javascrip-java.jpg)
...
![historia de JavaScript](./cronologia-javascript-1.png)
...
![historia de javascript](./cronologia-javascript-2.png)
...
>**¿Quieres aprender JavaScript desde cero hasta el nuevo estándar de ECMAScript 6?** Hazlo con mi ebook [*Aprendiendo JavaScript*](https://leanpub.com/aprendiendo-javascript) que ya tienen más de 400 lectores. Consíguelo [aquí](https://leanpub.com/aprendiendo-javascript)
...
Aunque no deja de ser un *azúcar sintáctico (Sugar Syntax)* porque en JavaScript no tenemos clases, tenemos prototipos. 
...
![Chrome Flags](./chrome-flags.png)

Y activar el flag **Enable Experimental JavaScript**.

Esto te permitirá probar algunas *features* pero no todas porque algunas aún están en desarrollo.
...
Por medio de [plugings y paquetes](https://babeljs.io/docs/en/plugins) podemos utilizar estas *features* incluso las que estean en desarrollo para próximas versiones si [elegimos el paquete correspondiente](https://babeljs.io/setup).
...
![ES6 next stop](./autopista-hacia-es6.png)

>**¿Quieres aprender JavaScript desde cero hasta el nuevo estándar de ECMAScript 6?** Hazlo con mi ebook [*Aprendiendo JavaScript*](https://leanpub.com/aprendiendo-javascript) que ya tienen **más de 500 lectores**. Consíguelo [aquí](https://leanpub.com/aprendiendo-javascript)