...
slug: "/gatsby-deploy-firebase"
date: 2020-02-13
banner: "./gatsby-deploy-firebase-seo.jpg"
tags:
    - "💻 Desarrollo"
---
Recientemente he migrado este blog a Gatsby para hacerlo más *serverless* y mi intención era subirlo a un CDN e implementar *integración continua* para olvidarme de desplegar manualmente. En este artículo te explico como lo he montado yo con Firebase Hosting y Travis. ¡Vamos a ello!
...
![gatsby stater](./gatsby-starter.png)
...
![Firebase console crear proyecto](./gatsby-firebase-console.png)
...
Dirígete a la carpeta de tu proyecto creado con Gatsby e inicia Firebase en él despues de loguearte:
...
```javascript:title=firebase.json
{
  "hosting": {
    "public": "public",
    "ignore": [
...
Una vez lo tengas, ve a la web de [Travis CI para proyectos open source](https://travis-ci.org) se distingue de la PRO, porque acaba en `.org` en lugar de `.com`. Esto hace que nuestros *builds* sean ilimitados y gratuitos.
...
![activar travis en tu repositorio](./gatsby-travis.png)

Seguidamente ve al menú de opciones y elige `settings`:

![opciones de travis](./gatsby-travis-options.png)
...
![Variables de entorno en Gatsby](./gatsby-env.png)

Para conseguir el token de Firebase podemos hacerlo por linea de comandos con la siguiente instrucción.
...
![configura tokens como variables de entorno en travis](./gatsby-env-firebase-token.png)

Ahora ya tenemos Travis listo, sólo nos queda decirle que tiene que hacer :)
