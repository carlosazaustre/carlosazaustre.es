...
slug: "/autenticacion-con-token-en-node-js"
date: 2015-02-23
tags:
    - "💻 Desarrollo"
---
...
Si te pierdes un poco, en [éste post anterior expliqué como crear un API REST en Node.js con Express y MongoDB](/como-implementar-una-api-rest-con-mongodb-node-js-usando-express-v4/). Y si prefieres también tengo un [videotutorial en YouTube sobre el tema](https://www.youtube.com/watch?v=SKoK6braZlk&list=PLUdlARNXMVkl9MJl4r90Z1j1nmAfWEPV3).
...
Creamos el servicio que utilizaremos para codificar el token. Para ello vamos utilizar la librería [jwt-simple](https://www.npmjs.com/package/jwt-simple) que nos facilita la vida a la hora de codificar el *payload* y hace todo el trabajo que expliqué en el [post anterior](/que-es-la-autenticacion-con-token/).
