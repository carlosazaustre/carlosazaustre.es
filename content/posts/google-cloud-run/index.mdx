...
![crear proyecto en Google Cloud](./Screenshot-2019-07-02-at-21.02.43.png)

![Nuevo proyecto en Google Cloud](./Screenshot-2019-07-02-at-21.03.12.png)

![Creando el proyecto](./Screenshot-2019-07-02-at-21.03.25.png)

![Proyecto creado y Project ID](./Screenshot-2019-07-02-at-21.03.51.png)

> Para poder usar Google Cloud necesitas una cuenta de gmail, activar el *billing*. Si es la primera vez que te registras tienes [300$ de *free trial*](https://console.developers.google.com/billing/freetrial?hl=en).
...
![Activación de APIs en Google Cloud](./Screenshot-2019-07-02-at-21.05.19.png)

Clickamos en *Enable APIs and Services* y buscamos Cloud Run

![Cloud Run](./Screenshot-2019-07-02-at-21.05.50.png)

Activamos el API de Cloud Run y hacemos lo mismo con Cloud Build

![Activar API de Cloud Run](./Screenshot-2019-07-02-at-21.05.58.png)

![Activar API de Cloud Build](./Screenshot-2019-07-02-at-21.34.05.png)
...
![Aplicacion Node.js corriendo en un contenedor Docker en Localhost](./Screenshot-2019-07-05-at-17.59.45.png)
...
![Cloud Build Triggers](./Screenshot-2019-07-02-at-22.57.51.png)

Al crearlo elegimos que la fuente será un repositorio de GitHub:

![Crear Trigger](./Screenshot-2019-07-02-at-22.58.02.png)
...
![Trigger Github repository](./Screenshot-2019-07-02-at-22.58.40.png)
...
![Screenshot-2019-07-02-at-23.30.39](./Screenshot-2019-07-02-at-23.30.39.png)
...
![Trigger creado](./Screenshot-2019-07-02-at-22.59.41.png).
...
![Histórico de triggers en Cloud Build](./Screenshot-2019-07-05-at-18.17.00.png)

Si ha sido correcto, puedes revisar en el Container Registry si la imagen de Docker ha sido creada:

![Imagen de Docker en el Container Registry](./Screenshot-2019-07-02-at-23.07.23.png)

Y por último, en Cloud Run revisa que se está ejecutando

![Cloud Run Ejecutándose](./Screenshot-2019-07-02-at-23.18.36.png)
...
![Permitir invocaciones externas](./Screenshot-2019-07-05-at-18.45.44.png)
...
Y ya estaría! Clicka en la URL que aparece asociada a tu proyecto y si todo va bien tendrás algo así en el navegador:

![App corriendo](./Screenshot-2019-07-05-at-18.25.03.png)
