...
slug: "/docker-como-entorno-de-desarrollo-local"
banner: "./docker-entorno-desarrollo-local.jpg"
date: 2018-09-01
tags:
  - "💻 Desarrollo"
---
...
<pre class="language-shell"><code class="language-shell">FROM node:4.4.0
...
<pre class="language-shell"><code class="language-shell">root@ubuntu:/home/carlosazaustre/Development/project# docker-compose build
Building web
...
Successfully built b151f82fbff3</code>
</pre>

Y después `$ docker-compose up` para ponerlo en marcha:

<pre class="language-shell"><code class="language-shell">root@ubuntu:/home/carlosazaustre/Development/project# docker-compose up
...
<pre class="language-shell"><code class="language-shell">Recreating project_web_1
Attaching to project_web_1
web_1 | npm info it worked if it ends with ok
web_1 | npm info using npm@2.14.20
web_1 | npm info using node@v4.4.0
...
web_1 | [nodemon] watching: *.*
web_1 | [nodemon] starting `node app.js`
web_1 | Server running on port 3000</code>
</pre>
...
![Docker Hola Mundo](./docker-entorno-desarrollo-hola-mundo.png)
...
![Docker como entorno de desarrollo](./docker-entorno-desarrollo-livereload.png)
