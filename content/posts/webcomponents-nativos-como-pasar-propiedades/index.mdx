...
slug: "/webcomponents-nativos-como-pasar-propiedades"
date: 2018-08-31
banner: "./webcomponents-nativos-propiedades.png"
tags:
  - "💻 Desarrollo"
---
...
En ese caso hay que hacer algo más de "fontanería". Imaginemos que ahora nuestro *custom-element* queremos que tenga ésta pinta y que ademas sus propiedades sean *observables*:
...
<sell-button intro="Oferta" text="Comprar Ahora"></sell-button>
```
![](./Screen-Shot-2017-03-22-at-17.41.05.png)
...
![](./Screen-Shot-2017-03-23-at-09.18.08.png)
...
* [*Observing Changes to Attributes*: Custom Elements v1 Reusable Web Components por Google Developers](https://developers.google.com/web/fundamentals/getting-started/primers/customelements#upgrades)
