...
slug: "/tutorial-ejemplo-de-aplicacion-web-con-angular-js-y-api-rest-con-node/"
date: 2014-01-13
tags:
    - "💻 Desarrollo"
---
[AngularJS](/empezando-con-angular-js) es uno de los frameworks más populares para desarrollar aplicaciones del lado cliente (Frontend) con JavaScript.</p>

Éste tutorial, <a href="https://scotch.io/tutorials/javascript/creating-a-single-page-todo-app-with-node-and-angular">basado en éste otro de Scotch.io</a> nos sirve para empezar a desarrollar profesionalmente con AngularJS.</p>

Vamos a ver como crear una [*Single Page Application*](//en.wikipedia.org/wiki/Single-page_application), y como conectarla a una [API REST construida con NodeJS](/como-crear-una-api-rest-usando-node-js/) y Mongo como base de datos. Completando así el Stack tecnológico conocido como, [MEAN](http://mean.io).
...
![Esquema arquitectura de apliación web con AngularJS y NodeJS](./tutorial-angular-node-esquema-arquitectura-aplicacion-web.png)
...
<div class="well"><table><tbody><tr><th>HTTP</th><th>URL</th><th>Descripción</th></tr><tr><td>GET</td><td>/api/todos</td><td>Devuelve todas las tareas de la BD</td></tr><tr><td>POST</td><td>/api/todos</td><td>Crea una tarea</td></tr><tr><td>DELETE</td><td>/api/todos/:todo</td><td>Borra una tarea</td></tr></tbody></table></div>
...
![Ejemplo de Aplicación web on AngularJS y un API REST con NodeJS](./tutorial-angularjs-node-ejemplo-aplicacion-web.png)
