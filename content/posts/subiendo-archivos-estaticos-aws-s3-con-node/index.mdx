...
date: 2013-09-19
slug: "/subiendo-archivos-estaticos-aws-s3-con-node"
tags:
  - "💻 Desarrollo"
---

S3 (*Amazon **S**imple **S**torage **S**ervice*) es un Disco Duro en la nube que forma parte los *Amazon Web Services*. Suele ser útil para almacenar los ficheros estáticos de nuestras aplicaciones web si queremos repartir la carga entre los servidores.
...
![Grunt.js](./2015/02/grunt-logo_g3kshp-1.png)
