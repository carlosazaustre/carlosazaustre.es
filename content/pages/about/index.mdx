...
¡Hola! Mi nombre es Carlos Azaustre. Nací hace 35 años en Madrid (España). Estudié [Ingeniería en Telemática en la UC3M](http://www.uc3m.es/ss/Satellite/Grado/es/Detalle/Estudio_C/1371212560793/1371212987094/Grado_en_Ingenieria_Telematica#programa) y actualmente trabajo en el equipo de *Incubation* de [Eventbrite](https://www.eventbrite.com/) como **Senior Front-End Engineer**. En 2019 fui nombrado [GDE en Tecnologías web](https://google-developers.appspot.com/community/experts/directory/profile/profile-carlos_azaustre) por Google.

Paralelamente dedico parte de mi tiempo a seguir formándome y aprendiendo cada día sobre **JavaScript** y otras tecnologías como **Node.js, Firebase, React y Vue.js**. Durante los últimos años he publicado varios ebooks, cursos online e impartido charlas y talleres. También publico contenido en [este blog](https://carlosazaustre.com) y en [mi canal de Youtube](https://youtube.com/carlosazaustre?sub_confirmation=1)

![IMG_20171203_114321](./IMG_20171203_114321.jpg)
...
* **1995**: 🎮 Paso un montón de fines de semana en casa de mis abuelos jugando al [Zelda de la Super Nintendo](https://en.wikipedia.org/wiki/The_Legend_of_Zelda:_A_Link_to_the_Past) con mi tío. Aprendo que *Compass* en inglés significa *Brújula*. 
...
* **2004**: 👨‍🎓 Termino *Desarrollo de Productos Electrónicos*, un Ciclo Formativo de Grado Superior y decido ir a la Universidad a estudiar Telemática.
...
* **2010**: 📺 [Nos entrevistan en Cuatroº](https://youtu.be/9Fyaxh_4cWE?t=114), hablando de Pardillos como motivo del lanzamiento en España de LOST.
* **2010**
    * 🖥 Compro mi primer iMac.
    * 👨‍🎓 Finalizo *Ingeniería Técnica de Telecomunicaciones: Especialidad en Telemática*.
* **2012**:
    * 🐶 Adoptamos a Kara.
    * El último volumen de Pardillos [consigue el 100% de la financiación vía *crowdfunding* en 24h](https://www.verkami.com/locale/es/projects/1576-pardillos-6%C2%AA-temporada).
    * 👨‍🎓 Me graduo en *Ingeniería Telemática*.
    * Paola y yo emigramos a Cork, Irlanda 🇮🇪 durante 1 año trabajando como *Freelances*
...
* **2015**: 
    * 📓 Publico el ebook [*Desarrollo web ágil con AngularJS*](https://www.amazon.com/Desarrollo-web-%C3%A1gil-Angular-js-Spanish-ebook/dp/B00MNHZCT2)
...
* **2016**
    ...
    * 📓 Publico [*Aprendiendo JavaScript* en LeanPub](https://leanpub.com/aprendiendo-javascript).
* **2017**
    ...
    * 💼 empezando a trabajar en Google en el equipo de *Developer Relations* coordinando las comunidades tech.
* **2018**: 
...
Fue por entonces cuando empecé [éste blog](/blog) para compartir el conocimiento que iba aprendiendo por el camino.

![Carlos Azaustre en el Googleplex, Mountain View, California](./12689_10151922710569376_548012013_n.jpg)
...
![carlosazaustre-tetuanvalley](./carlosazaustre-tetuanvalley.png)
...
![carlosazaustre-google-groups-gdg](./carlosazaustre-google-groups-gdg.png)
...
### Vuelta al "metal"
Acabé mi etapa en Google en Noviembre de 2018, y tras un pequeño *break* en el que estuvimos viviendo un mes en Los Ángeles 🇺🇸, volvimos a España y comencé a trabajar en remoto con el equipo de *Quantum Computing* de **IBM Research** de Nueva York 🇺🇸 cómo **Senior Frontend Engineer**. Tras un tiempo, cambié de aires por un puesto similar pero para **Eventbrite** desde sus oficinas en Madrid 🇪🇸

Unos meses más tarde, **Google** me nombró **Expert en Tecnologías Web** dentro de su programa GDE (Google Developers Experts).

***

### Contacto

[Mencíoname en Twitter (soy @carlosazaustre)](https://twitter.com/carlosazaustre). Suelo estar pendiente de las redes sociales.
